...
<body>
<div class="menu">
  <h1>Textil Export, hola administrador...</h1>
...
<div class="container">
  <div class="d-flex justify-content-between">
    ...
    <button class="btn btn-success" onclick="window.location.href='funciones/nuevoProducto.php'">Nuevo Producto</button>
...
<div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
  <div class="modal-dialog">
    ...
    require_once 'funciones/funcionesAdmin.php';
    $obj1 = new Pog(); 
    $obj1->mostrarCartas(); 
    ?>
    </div>
